...
from api.insights.company_description.company_description_fetcher import (
...
class Query:
    ...
    @strawberry.field
    def company_description(self, domain: str) -> str:
        return get_company_description(domain=domain)
